...
List<RiwayatPengajuanModels> riwayatPengajuanModelsFromJson(String str) => List<RiwayatPengajuanModels>.from(json.decode(str).map((x) => RiwayatPengajuanModels.fromJson(x)));

String riwayatPengajuanModelsToJson(List<RiwayatPengajuanModels> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class RiwayatPengajuanModels {
    final int id;
    ...
    factory RiwayatPengajuanModels.fromJson(Map<String, dynamic> json) => RiwayatPengajuanModels(
        id: json["id"],
