...
List<RiwayatDitolakModels> riwayatPengajuanModelsFromJson(String str) => List<RiwayatDitolakModels>.from(json.decode(str).map((x) => RiwayatDitolakModels.fromJson(x)));

String riwayatPengajuanModelsToJson(List<RiwayatDitolakModels> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class RiwayatDitolakModels {
    final int id;
    ...
    factory RiwayatDitolakModels.fromJson(Map<String, dynamic> json) => RiwayatDitolakModels(
        id: json["id"],
