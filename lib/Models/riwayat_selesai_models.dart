...
List<RiwayatSelesaiModels> riwayatPengajuanModelsFromJson(String str) => List<RiwayatSelesaiModels>.from(json.decode(str).map((x) => RiwayatSelesaiModels.fromJson(x)));

String riwayatPengajuanModelsToJson(List<RiwayatSelesaiModels> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class RiwayatSelesaiModels {
    final int id;
    ...
    factory RiwayatSelesaiModels.fromJson(Map<String, dynamic> json) => RiwayatSelesaiModels(
        id: json["id"],
